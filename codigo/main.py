...
if __name__ == "__main__":
    ...
    obstacles.initialize_obstacle('nuddle', random.randint(1980, 2080), random.randint(80, 110), width=100, height=500)
    obstacles.initialize_obstacle('clif', random.randint(2380, 2480), random.randint(510, 610), width=100, height=500)
    obstacles.initialize_obstacle('nuddle', random.randint(2980, 3080), random.randint(-90, 10), width=100, height=500)       
    obstacles.initialize_obstacle('clif', random.randint(3680, 3780),random.randint(400, 500), width=100, height=500)
    obstacles.initialize_obstacle('nuddle', random.randint(4280, 4380), 110, width=100, height=500)
