...
if __name__ == "__main__":
    ...
    explosion = ExplosionAnimation(game.window)
    ...
    obstacles.initialize_obstacle('nuddle', random.randint(4180, 4280), 110, width=100, height=500)
    obstacles.initialize_obstacle('clif', 4680, 510, width=100, height=500)
    game.run(obstacles, nave, menu, explosion)